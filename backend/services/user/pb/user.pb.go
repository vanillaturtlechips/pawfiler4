...
type UserProfile struct {
	...
	TotalLikesReceived   int32                  `protobuf:"varint,16,opt,name=total_likes_received,json=totalLikesReceived,proto3" json:"total_likes_received,omitempty"`
	TotalCommentsWritten int32                  `protobuf:"varint,17,opt,name=total_comments_written,json=totalCommentsWritten,proto3" json:"total_comments_written,omitempty"`
	SuspiciousVideos     int32                  `protobuf:"varint,18,opt,name=suspicious_videos,json=suspiciousVideos,proto3" json:"suspicious_videos,omitempty"`
	AvgConfidence        float64                `protobuf:"fixed64,19,opt,name=avg_confidence,json=avgConfidence,proto3" json:"avg_confidence,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *UserProfile) GetTotalLikesReceived() int32 {
	if x != nil {
...
func (x *UserProfile) GetTotalCommentsWritten() int32 {
	if x != nil {
		return x.TotalCommentsWritten
	}
	return 0
}

func (x *UserProfile) GetSuspiciousVideos() int32 {
	if x != nil {
		return x.SuspiciousVideos
	}
	return 0
}

func (x *UserProfile) GetAvgConfidence() float64 {
	if x != nil {
...
const file_user_proto_rawDesc = "" +
	...
	"bestStreak\x120\n" +
	"\x14total_likes_received\x18\x10 \x01(\x05R\x12totalLikesReceived\x124\n" +
	"\x16total_comments_written\x18\x11 \x01(\x05R\x14totalCommentsWritten\x12+\n" +
	"\x11suspicious_videos\x18\x12 \x01(\x05R\x10suspiciousVideos\x12%\n" +
	"\x0eavg_confidence\x18\x13 \x01(\x01R\ravgConfidence\"\x96\x01\n" +
